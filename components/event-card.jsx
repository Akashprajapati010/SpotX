...
import { Calendar, MapPin, QrCode, Users, Trash2, X, Eye } from "lucide-react";
...
export default function EventCard({
    ...
    if (variant === "list") {
        return(
            <Card
            className={`py-0 group cursor-pointer hover:shadow-lg transition-all
                hover:border-purple-500/50 ${className}`}
                onClick={onClick}
                >
